...
//	CreateWindowA("button", "Click me!", WS_VISIBLE | WS_CHILD | ES_CENTER, 5, 60, 120, 30, hWnd, (HMENU)OnButtonClicked, NULL, NULL, NULL);
	...
	CreateWindowA("button", "StartGUI", WS_VISIBLE | WS_CHILD | ES_CENTER, 10, 110, 60, 18, hWnd, (HMENU)OnButtonStartGUIClicked, NULL, NULL, NULL);
	CreateWindowA("button", "StopGUI", WS_VISIBLE | WS_CHILD | ES_CENTER, 10, 150, 60, 18, hWnd, (HMENU)OnButtonStopGUIClicked, NULL, NULL, NULL);
